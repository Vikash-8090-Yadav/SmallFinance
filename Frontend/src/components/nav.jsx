...
function Nav() {
  ...
  const fetchBalance = async () => {
    ...
    const finalbalance = web3.utils.fromWei(balanceWei,"ether")+ " "+networks["SepoliaTestnet"]["nativeCurrency"]["name"];
  ...
  const SepoliaTestnetChainId = parseInt(networks.SepoliaTestnet.chainId, 16);
  ...
  if(chainId1 !== SepoliaTestnetChainId){
...
>
  ...
  <div className=" mmh text-lg mx-3">Samll Finance</div>
</a>
</div>
  <button
            id="sidebarToggleTop"
